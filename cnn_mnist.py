...
def cnn_vgg16_model_fn(features, labels, mode):
    """Model function for CNN."""
    # Input Layer
    # Reshape X to 4-D tensor: [batch_size, width, height, channels]
    # MNIST images are 28x28 pixels, and have one color channel
...
def serving_input_receiver_fn():
    ...
    # serialized_tf_example = tf.placeholder(dtype=tf.float32, shape=[None], name='input_tensors')
...
def estimator_go():
    ...
    #model_dir = r"/tmp/mnist_convnet_model"
    model_dir = r"/tmp/mnist_convnet_vgg_16_model"
    mnist_classifier = tf.estimator.Estimator(model_fn=cnn_vgg16_model_fn,
                                              model_dir=model_dir)
